...
|評估項目|量尺|
|---|---|
|準時推送|根據最後一次git commit日期時間。<br>4:準時commit內容完成所有目標<br>3:準時commit內容完成至少一種目標<br>2:延遲commit內容完成所有目標<br>1:延遲commit內容完成至少一種目標<br>0:未繳|
|演練充分度|單元演練項目達標比例。<br>4:所有練習達成預定水準<br>3:超過60%的練習達成預定水準<br>2.超過30%的練習達成預定水準<br>1:至少一項練習達成預定水準<br>0:沒有練習達成預定水準/未繳|
|演練活用度|使用單元演練技巧應用於非教材場合。<br>以同學在電子書討論區發言，被授課教師標註的狀況評分|
